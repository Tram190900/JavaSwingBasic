...
public class GiaiPhuongTrinh extends JFrame implements ActionListener {
	...
	private String giaiPhuongTrinh(int a, int b, int c) {
		...
		if (a == 0) {
            if (b == 0) {
                return s+ "Phương trình vô nghiệm!";
            } else {
                return s + "Phương trình có một nghiệm:" + (-c / b);
            }
        }
        // tính delta
        ...
        if (delta > 0) {
            ...
            return s + "Phương trình có 2 nghiệm là: " + x1 + " và " + x2;
        } else if (delta == 0) {
            x1 = (-b / (2 * a));
            return s + "Phương trình có nghiệm kép: "+ x1;
        } else {
            return s + "Phương trình vô nghiệm!";
        }
	}
